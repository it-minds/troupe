...
```sh
# 1. the daemon: install it (install.sh / install.ps1 at the repository root; -y for
#    the daemon alone, --gui for this app too) or build it in ../../apps/troupe_daemon with
