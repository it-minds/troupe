...
What the platform does behind these screens — how approvals work, what an agent or a profile is, budgets, why sessions go to sleep — is documented in the server repository, which is separate from this one: [../../../troupe-remote/docs/user/features.md](../../../troupe-remote/docs/user/features.md).
