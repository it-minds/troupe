...
Boundaries are enforced by the build: apps/desktop imports @troupe/client and nothing from the remote's repository; @troupe/client depends on no framework; nothing in the GUI reads a file under $TROUPE_STATE_HOME except daemon.json.  
