...
The project brief at the top of this prompt already maps this repository. Use it to go straight to the relevant files instead of listing the tree or grepping blind, and report only what it does not already say.
