...
| Start here | If you |
|---|---|
| [user/](user/README.md) | use Troupe: the concepts, the clients, what Troupe never does |
| [admin/](admin/README.md) | run a deployment: install, configure, identity, profiles, bundles, backups, monitoring |
