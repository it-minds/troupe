...
| `minio` | `minio/minio:RELEASE.2025-04-22T22-12-26Z` | 59000 (S3), 59001 (console) | `troupe` / `troupe-secret` | `minio-setup` creates bucket `troupe-sessions` and enables versioning (`:74-85`) |
