...
| `k8s` | 2.8.0 | `apps/troupe_operator/mix.exs:36`; `apps/troupe_plane/mix.exs:54` | plane: "For TokenReview at enrolment, and for writing the two custom resources the plane is allowed to write" (`:51-53`). Discrepancy: the plane writes only `WorkerProfile` ([../history/AUDIT.md](../history/AUDIT.md) §2) |
